...
##CONFIGURAÇÕES
####  TITULO DO MENU  #################################################################
title_menu = '[B][COLOR white]:::[/COLOR] [COLOR pink] BEM-VINDOS [/COLOR] [COLOR white]:::[/COLOR][/B]'
###  DESCRIÇÃO DO ADDON ###############################################################
title_descricao = '[COLOR white][B]VTV [COLOR pink][B]Online[/B][/COLOR] - [COLOR beige][B]Melhor conteudo de filmes e séries para você e toda sua família[/COLOR][/B]'
...
## MENU CONFIGURAÇÕES
menu_configuracoes = '[B][COLOR red]»» [COLOR pink]CONFIGURAÇÕES[/COLOR][/B]'
...
#### POP UP SUPORTE
titulo_suporte = '[COLOR lime][B]BEM-VINDOS  AO [/B][/COLOR] [COLOR white][B]VTV [COLOR pink][B]Online[/B][/COLOR]'
...
thumbnail_vip = 'https://i.postimg.cc/P5xyR8n8/Whats-App-Image-2021-07-06-at-13-27-46.jpg'
fanart_vip = 'https://i.postimg.cc/Kjxrr15j/Whats-App-Image-2021-07-06-at-13-22-00.jpg'
#### DESCRIÇÃO VIP ###########################################################
vip_descricao = '[COLOR aqua][B]SOLICITE SEU ACESSO VIP, O MENOR PREÇO DE TODOS -APARTIR DE [COLOR red][B]20,00 REAIS[/B][/COLOR] [B]Solicite Seu Teste[/B][/COLOR] [COLOR red][B]55+ (83) 8793-5947[/B][/COLOR]'
...
##SERIVODR VIP
url_server_vip = 'http://ppvx.xyz:80'
...
url_b64_principal = 'aHR0cHM6Ly9wYXN0ZWJpbi5jb20vcmF3L0NBZ2syUVBC'
...
def suporte():
    ...
    import webbrowser
    dialog = xbmcgui.Dialog()
    link_vip = 'https://api.whatsapp.com/send/?phone=558387935947&text=Solicito+login+teste+de+acesso+VIP+VTV+Online&app_absent=0'
    link_facebook = ''
    link_telegram = ''
    link = dialog.select(titulo_suporte, ['[COLOR white][B]VTV [COLOR pink][B]Online[/B][/COLOR] [COLOR yellow][B] VIP[/B][/COLOR] [COLOR white][B]Solicite Seu Teste[/B][/COLOR] [COLOR red][B]55+ (83) 8793-5947[/B][/COLOR]','[COLOR aqua][B]Conteúdo de forma rápida e com qualidade, Agregamos todos os dias o melhor conteúdo da Internet[/B][/COLOR],',' [COLOR lime][B] ● [COLOR red][B]TV   [COLOR lime][B] ● [COLOR gold][B]FILMES  [COLOR lime][B] ● [COLOR blue][B]SÉRIES [COLOR lime][B] ● [COLOR magenta][B]DESENHOS [COLOR lime][B] ● [COLOR aqua][B]NOVELAS [COLOR yellow]E [COLOR red]MAIS!!![/COLOR][/B]','[COLOR magenta][B]ENTRAR NO ADDON AQUI[/COLOR][/B]'])
    if link == 0:
