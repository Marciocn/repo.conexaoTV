...
url_b64_principal = 'aHR0cHM6Ly9jbGQucHQvZGwvZG93bmxvYWQvMDJlMGE0ZjktNGFjNi00ZDk1LWEwNTQtODUwMmRiMjNiN2ZlL05vdmElMjBWZXJzJUMzJUEzby54bWw/ZG93bmxvYWQ9dHJ1ZQ=='
...
def info_vip():
    ...
    server_vip = addon.getSetting('servid')
    if int(server_vip) == 0:
...
def vip():
    ...
    if vip_menu == 'true':
        if username_vip > '' and password_vip > '':
            url = url_server_vip+'/get.php?username=%s&password=%s&type=m3u_plus&output=%s'%(username_vip,password_vip,saida_canal)
